...
namespace MMS.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        ILogger<AccountController> logger, ApplicationDbContext appContext)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> GetRoles(int pageNumber, int pageSize)
        {
            ...
            foreach (var res in result)
            {
                ...
                var responce = new RoleViewModel
                {
                    Id = res.Id,
                    Name = res.Name,
                    ParentRoleId = _appContext.Roles.Where(x => x.Id == res.ParentRoleId).FirstOrDefault() == null ? null : res.ParentRoleId,
                    ParentRoleName = res.ParentRoleId == null ? null : _appContext.Roles.Where(x => x.Id == res.ParentRoleId).FirstOrDefault().Name,

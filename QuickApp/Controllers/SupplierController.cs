...
namespace MMS.Controllers
{
    ...
    public class SupplierController : ControllerBase
    {
        ...
        public IActionResult ExportSupplier(List<Supplier> res)
        {
            Stream stream = null;
            ...
            try
            {
                ...
                {
                    excelPackage.Workbook.Properties.Title = "Supplier Details";


                    excelPackage.Workbook.Worksheets.Add("Supplier Details");
                    ...
                    worksheet.Cells[iRowCnt - 1, 1].Value = "SupplierId";
                    worksheet.Cells[iRowCnt - 1, 2].Value = "Supplier Reference";
                    worksheet.Cells[iRowCnt - 1, 3].Value = "Name 1";
                    worksheet.Cells[iRowCnt - 1, 4].Value = "Name 2";
                    worksheet.Cells[iRowCnt - 1, 5].Value = "Address";
                    worksheet.Cells[iRowCnt - 1, 6].Value = "Email";
                    worksheet.Cells[iRowCnt - 1, 7].Value = "Contact Number";
                    worksheet.Cells[iRowCnt - 1, 8].Value = "Note";
                   
                    worksheet.Cells[iRowCnt - 1, 9].Value = "Is Active";
                    worksheet.Cells[iRowCnt - 1, 10].Value = "Created Date";
                    worksheet.Cells[iRowCnt - 1, 11].Value = "Updated Date";

                    int i;
                    for (i = 0; i <= res.Count - 1; i++)
                    {
                        worksheet.Cells[iRowCnt, 1].Value = res[i].Id;
                        worksheet.Cells[iRowCnt, 2].Value = res[i].SupplierReference;
                        worksheet.Cells[iRowCnt, 3].Value = res[i].Name1;
                        worksheet.Cells[iRowCnt, 4].Value = res[i].Name2;
                        worksheet.Cells[iRowCnt, 5].Value = res[i].Address;
                        worksheet.Cells[iRowCnt, 6].Value = res[i].Email;
                        worksheet.Cells[iRowCnt, 7].Value = res[i].ContactNumber;
                        worksheet.Cells[iRowCnt, 8].Value = res[i].Note;
                       
                        worksheet.Cells[iRowCnt, 9].Value = res[i].IsActive;
                        worksheet.Cells[iRowCnt, 10].Value = res[i].CreatedDate;
                        worksheet.Cells[iRowCnt, 10].Style.Numberformat.Format = @"dd-MM-yyyy";
                        worksheet.Cells[iRowCnt, 11].Value = res[i].UpdatedDate;

...
export class AssetsComponent implements OnInit {
  ...
  displayedColumns = [ 'assetLocationRef','name1', 'name2','siteName1', 'projectName1', 'locationName1', 'astGroupName1', 'astTradeName1',  'assetCounter', 'assetSize', 'assetCapacity', 'astFixedDate', 'Actions'];
